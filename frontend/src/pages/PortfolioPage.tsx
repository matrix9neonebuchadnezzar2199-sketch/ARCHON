  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Current positions and P&L overview.
      ...
      {hasPositions ? (
        ...
        <Card>
          <CardContent className="py-12 text-center text-muted-foreground">
            No open positions. Run an analysis or backtest to populate the portfolio.
          </CardContent>
        </Card>
      )}
      ...
      {portfolio?.engine_results && Object.keys(portfolio.engine_results).length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Latest Engine Results</CardTitle>
          </CardHeader>
          <CardContent>
